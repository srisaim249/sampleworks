...
func setUpServer() http.Handler {
	accounts := repository.NewAccounts(
		defaultSmartMeterToPricePlanAccounts(),
	)
	...
	sampleMsgLogger := log.WithField("endpoint", "pricePlans")

	mux.Handle("/sample", priceplans.MakeCompareAllPricePlansHandler(pricePlansService, pricePlansLogger))
